...
export class FfmpegProcess {
  ...
  constructor(cameraName: string, sessionId: string, videoProcessor: string, ffmpegArgs: string, log: FfmpegLogger,
    debug = false, delegate: CameraDelegate, callback?: StreamRequestCallback) {
